...
def my_identiy(inputs):
    ...
    return x
#------------------------------------添加层的方式---------------------#
#my_identiy_layer1 = Lambda(minus, name='my_identiy_layer1')(x)
...
def darknet_body(x):
    ...
    feat1 = Lambda(my_identiy, name='feat1')(x)#############原来feat1=x

    # 52,52,256 -> 26,26,512
    x = resblock_body(x, 512, 8)
    feat2 = Lambda(my_identiy, name='feat2')(x)#############原来feat2=x

    # 26,26,512 -> 13,13,1024
    x = resblock_body(x, 1024, 4)
    feat3 = Lambda(my_identiy, name='feat3')(x)#############原来feat3=x
