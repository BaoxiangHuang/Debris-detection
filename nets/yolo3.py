...
def yolo_body(inputs, num_anchors, num_classes):
    ...
    # --------自建backbone resnet50-----------------------------------------#
    # feat1,feat2,feat3 = ResNet50(input_tensor=inputs).output
    # #print('feat',feat1,feat2,feat3)
    # darknet_res = Model(inputs, feat3)
    ...
    # # darknet_vgg = Model(inputs, feat3)    #试验表明此函数可以不用，直接填入feat3,而无需darknet_vgg.output
    # --------------------------------------------------------------------#

    # --------自建backbone mobilenetv2-------------------------------------------#
    feat1, feat2, feat3 = MobileNetV2(inputs)
    # darknet_mobile = Model(inputs, feat3)   #试验表明此函数可以不用，直接填入feat3，而无需darknet_mobile.output
    # --------------------------------------------------------------------#
    ...
    x, y1 = make_last_layers(feat3, 512, num_anchors*(num_classes+5))############# 原来是：darknet.output,,   可以改成feat3，即不需要darknet=Model(inputs, feat3)
