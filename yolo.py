...
class YOLO(object):
    _defaults = {
        "model_path"        : 'model_data/past_resnet50-yolov3-stage2-ep074-loss4.009-val_loss4.317.h5',
        "anchors_path"      : 'model_data/yolo_anchors.txt',
        "classes_path"      : 'model_data/coco_classes.txt',
        "score"             : 0.29,#原0.5
        "iou"               : 0.5,#原0.3
        "max_boxes"         : 100,
        "model_image_size"  : (416, 416),###原：416*416
        #---------------------------------------------------------------------#
    ...
    def detect_image(self, image):
        ...
        #   设置字体
        #---------------------------------------------------------#
        font = ImageFont.truetype(font='model_data/times.ttf',
